...
public class ZFB {
	//商户PID
	protected static final String PARTNER = "";
	//商户收款账号
	protected static final String SELLER = "";
	//商户私钥，pkcs8格式
	protected static final String RSA_PRIVATE = "";
	//支付宝公钥
...
//	private static final int SDK_CHECK_FLAG = 2;
	...
	protected String pay(String sign) {
		...
		// 调用支付接口，获取支付结果
		return alipay.pay(sign,true);
	}

	protected String payInLocal(String orderInfo){
		/**
