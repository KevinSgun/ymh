...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    public RoundedCornersTransformation(Context context, int radius) {
        this(context, radius, 0, CornerType.ALL,false);
    }
    public RoundedCornersTransformation(Context context, int radius, boolean squared) {
        this(context, radius, 0, CornerType.ALL,squared);
    }
    public RoundedCornersTransformation(Context context, int radius, int margin,boolean squared) {
        this(context, radius, margin, CornerType.ALL,squared);
    }

    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin, boolean squared) {
        this(pool, radius, margin, CornerType.ALL,squared);
    }

    public RoundedCornersTransformation(Context context, int radius, int margin, CornerType cornerType,boolean squared) {
        this(Glide.get(context).getBitmapPool(), radius, margin, cornerType,squared);
    }

    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin, CornerType cornerType, boolean squared) {
        super(pool);
        mBitmapPool = pool;
        mRadius = radius;
        mDiameter = mRadius * 2;
    ...
    public boolean equals(Object o) {
        return o instanceof RoundedCornersTransformation && ((RoundedCornersTransformation) o).mRadius == this.mRadius && ((RoundedCornersTransformation) o).mMargin == this.mMargin;
    }

    public int hashCode() {
        return "com.bumptech.glide.load.resource.bitmap.RoundedCorners".hashCode() + this.mRadius + this.mMargin;
    }
